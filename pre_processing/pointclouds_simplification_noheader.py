...
if __name__ == '__main__':
    ...
    scene = 'ScanNet/scene0024_00'
    # scene = 'Matterport3D/29hnd4uzFmX'
    input_path = '../pre_processing_results/%s/point_clouds.ply' % scene
    output_path = '../pre_processing_results/%s/point_clouds_simplified_2.ply' % scene
    ...
    if os.path.isfile(input_path):
        ...
        # [45,000,001,46,059,295]
        # [60,000,001,75,000,000]
        # [75,000,001,90,000,000],
        # [90,000,001,104,256,042]

        ##第二次简化 side_len=0.01, pervoxel=30
        #[1, 15000000],
        # [15000001,30000000],
        # [30000001,45000000],
        # [45000001,60000000],
        # [60000001,63611445]
        # sampler.loadfile(rstart=90000001,rlines=15000000)#start , length

        # 第三次简化 side=0.02,per=20
        # [1,15000000]
        # [15000001,30000000]
        # [30000001,45000000]
        # [45000001,47798374]

        # 第四次简化 side=0.02,per=20
        # [1,15000000]
        # [15000001,23501037]
        ...
        sampler.loadfile(rstart=50000002, rlines=7871836)
        sampler.sampling()
    else:
