...
if __name__ == '__main__':
    ...
    dir3 = 'D:/mycode/Neural-Point-Cloud-Rendering-via-Multi-Plane-Projection/data/ScanNet/%s/pose_test/' % scene
    dir4 = 'D:/mycode/Neural-Point-Cloud-Rendering-via-Multi-Plane-Projection/data/ScanNet/%s/color/' % scene
    point_clouds_path = 'D:/mycode/MPP/pre_processing_results/ScanNet_with_delta_11_random_sampling/%s/point_clouds_simplified_11.ply' % scene
    output_dir = 'D:/mycode/MPP/pre_processing_results/ScanNet_with_delta_11_random_sampling/%s/reproject_results_%s/' % (scene, num)
    output_dir1 = 'D:/mycode/MPP/pre_processing_results/ScanNet_with_delta_11_random_sampling/%s/weight_%s/' % (scene, num)
