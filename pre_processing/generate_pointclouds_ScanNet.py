...
if __name__ == '__main__':
    ...
    scene = 'scene0017_00'   # which scene used to generate point clouds.
...
#######################################################################################################################
    ...
    for i in range(num_image):
        ...
        # print(extrinsic_matrix[0:3, 0:3].dot(np.transpose(extrinsic_matrix[0:3, 0:3])))
        #
        # print(image.shape)
        # print(depth.shape)
        ...
        # print(point_clouds_color.shape)
        # print(point_clouds_colors.shape)
