...
if __name__ == '__main__':
    ...
    point_clouds_path = 'D:/mycode/Neural-Point-Cloud-Rendering-via-Multi-Plane-Projection/pre_processing_results/ScanNet/%s/point_clouds_simplified_2.ply' % scene
    output_dir = 'D:/mycode/Neural-Point-Cloud-Rendering-via-Multi-Plane-Projection/pre_processing_results/ScanNet_pcl_2/%s/reproject_results_%s/' % (scene, num)
    output_dir1 = 'D:/mycode/Neural-Point-Cloud-Rendering-via-Multi-Plane-Projection/pre_processing_results/ScanNet_pcl_2/%s/weight_%s/' % (scene, num)
